...
public class MyHashMap05<K,V> {
	...
	public V get(K key){
		...
		if(table[hash]!=null){
			...
			while(temp!=null){//如果值相等，说明找到了键值对，返回value值
	...
	public void put(K key,V value){
		...
		Node3 temp = table[newNode.hash];//把位桶数组对应hash值所在索引位置的内容设为临时变量（最开始是null）
...
//		System.out.println("%hash in myHash:"+(v%(length-1)));//取模，效率低
	...
	public static void main(String[] args) {
		MyHashMap05<Integer,String> m = new MyHashMap05<>();
		m.put(10, "a");
		m.put(20, "b");
		m.put(30, "c");
		m.put(20, "ssss");
